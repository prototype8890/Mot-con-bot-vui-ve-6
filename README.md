...
`PRICE_GUARD_RETRY_DELAY_MS` đặt khoảng nghỉ giữa các lần kiểm tra giá realtime (mặc định 250ms) để bot phản ứng nhanh với biến động
nhưng vẫn hạn chế spam RPC.
